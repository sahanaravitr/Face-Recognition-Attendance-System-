    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/sahana/Downloads/Face-Recognition-Attendance-System-main/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\sahana\Downloads\Face-Recognition-Attendance-System-main\Face-Recognition-Attendance-System-main\Attendance\Manually Attendance\-------Check atttendance-------"')
    ...
    if l1 == '':
        ...
        try:
            ...
            detector = cv2.CascadeClassifier(
                 r"C:\Users\sahana\AppData\Roaming\Python\Python313\site-packages\cv2\data\haarcascade_frontalface_default.xml")
            Enrollment = txt.get()
            Name = txt2.get()
            sampleNum = 0
            while (True):
            ...
            with open(r"C:\Users\sahana\Downloads\Face-Recognition-Attendance-System-main\Face-Recognition-Attendance-System-main\StudentDetails\StudentDetails.csv", 'a+') as csvFile:
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                df = pd.read_csv(r"C:\Users\sahana\Downloads\Face-Recognition-Attendance-System-main\Face-Recognition-Attendance-System-main\StudentDetails\StudentDetails.csv")
                cam = cv2.VideoCapture(0)
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/sahana/Download/Face-Recognition-Attendance-System-main/Face-Recognition-Attendance-System-main/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Users\sahana\Downloads\Face-Recognition-Attendance-System-main\Face-Recognition-Attendance-System-main\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'pragya':
            if password == 'pragya123':
                ...
                cs = 'C:/Users/sahana/Downloads/Face-Recognition-Attendance-System-main/Face-Recognition-Attendance-System-main/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
